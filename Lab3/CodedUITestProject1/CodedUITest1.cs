...
namespace CodedUITestProject1
{
    ...
    public class CodedUITest1
    {
        ...
        public void CodedUITestMethod2()
        {
            ...
            this.UIMap.RecordedMethod2(); // октрыть 
            this.UIMap.AssertMethod1(); // проверка 2
            this.UIMap.Close(); // закрыть
        ...
        public void CodedUITestMethod1()
        {
            ...
            this.UIMap.RecordedMethod1(); // октрыть 
            this.UIMap.Second_Test(); // проверка 1
            this.UIMap.Close(); // закрыть
        ...
        public void CodedUITestMethod3()
        {
            ...
            this.UIMap.RecordedMethod2();// отрыть и выполнить действие
            this.UIMap.TEst_3(); // Test 3
